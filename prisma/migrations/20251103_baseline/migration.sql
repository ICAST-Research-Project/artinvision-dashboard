...
-- CreateTable
CREATE TABLE "artwork_image_embeddings" (
...
-- CreateIndex
CREATE INDEX "artwork_image_embeddings_artwork_id_idx" ON "artwork_image_embeddings"("artwork_id");
...
-- AddForeignKey
ALTER TABLE "artwork_image_embeddings" ADD CONSTRAINT "artwork_image_embeddings_artwork_id_fkey" FOREIGN KEY ("artwork_id") REFERENCES "Artwork"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "artwork_image_embeddings" ADD CONSTRAINT "artwork_image_embeddings_artwork_image_id_fkey" FOREIGN KEY ("artwork_image_id") REFERENCES "ArtworkImage"("id") ON DELETE CASCADE ON UPDATE CASCADE;
